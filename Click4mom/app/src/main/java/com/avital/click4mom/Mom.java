...
public class Mom {
    ...
    public void updateMomTip (int tip){

        msg [tip].sent = true;
    }

    public void msgAddTimes (){ // add schedules to msg array
        ...
        if (weekNum == 1000000) {// free user
            ...
            makeTipsTimes2 (calendar); // the calendar is today
    ...
    public void makeTipsTimes2 (Calendar calendar){ //////////////////////////////////////////////////
